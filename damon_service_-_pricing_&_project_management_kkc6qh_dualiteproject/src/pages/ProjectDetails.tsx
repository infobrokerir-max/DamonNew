...
export default function ProjectDetails() {
  ...
  const { 
    ...
    updateProjectStatus, addComment, requestInquiry, approveInquiry, rejectInquiry 
  } = useStore();
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            {canInquire ? (
              <div className="bg-sky-50/50 border border-sky-100 rounded-xl p-5 mb-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <select 
                    className="p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 outline-none bg-white"
                  ...
                  <select 
                    className="p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 outline-none bg-white md:col-span-2"
              ...
              <table className="w-full text-right text-sm">
                <thead>
                  <tr className="border-b border-gray-100 text-gray-500">
                    ...
                    {currentUser.role !== 'employee' && <th className="pb-3 text-amber-600">قیمت لیست (P)</th>}
                ...
                <tbody className="divide-y divide-gray-50">
                  {projectInquiries.map(inq => {
                     ...
                     const showConfidential = currentUser.role !== 'employee';
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto space-y-6 max-h-[600px] pl-2 custom-scrollbar mb-4">
                   ...
                   return (
                     <div key={comment.id} className="flex justify-center">
                       <span className="bg-gray-100 text-gray-500 text-xs px-3 py-1 rounded-full">
                         {comment.body} - {new Date(comment.created_at).toLocaleTimeString('fa-IR', {hour: '2-digit', minute:'2-digit'})}
                       </span>
                     </div>
                   )
                 }
