  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 text-center">
        ...
        <div className="mt-8 text-right text-xs bg-gray-50 p-3 rounded border border-gray-100">
          <p className="font-bold mb-1">اطلاعات ورود پیش‌فرض (تست):</p>
          <p>ادمین: admin / sasan</p>
          <p>مدیر فروش: sales / 123</p>
          <p>کارمند: emp1 / 123</p>
        </div>
      </div>
    </div>
