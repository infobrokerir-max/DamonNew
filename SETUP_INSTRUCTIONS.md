...
## تغییر رمز عبور (Reset Password)

اگر رمز عبور را فراموش کرده‌اید یا می‌خواهید آن را تغییر دهید:
...
رمز عبور شما در Google Sheet به‌روزرسانی می‌شود و می‌توانید با رمز عبور جدید وارد شوید.

**توجه:** این قابلیت فقط برای محیط توسعه (Development) است و باید در محیط تولید (Production) غیرفعال شود.
